...
4. leer completo `docs/dominios/inmunologia/ACTA_DE_CONFORMIDAD_DE_TRANSICION_SECUENCIAL_DESDE_OP-IMM-001_AL_LENGUAJE_SV_2026_09_03.md`, incluida su adenda rectora de secuencia de 06/09/2026 (§§12–17) y los relevos de recepción N0-01 (§18) y reparación de oráculos (§19), y el acta de fase y las entradas RETP directamente aplicables;
