...
4. leer completo `docs/dominios/inmunologia/ACTA_DE_CONFORMIDAD_DE_TRANSICION_SECUENCIAL_DESDE_OP-IMM-001_AL_LENGUAJE_SV_2026_09_03.md`, incluida su adenda rectora de secuencia de 06/09/2026 (§§12–17) y los relevos de recepción N0-01 (§18), reparación de oráculos (§19), cierre relacional N0-02 (§20) unicidad de proyección N0-03 (§21) y referencia de arquitectura N0-04 (§22), retirada Python y deuda tecnológica diferida (§23) y unicidad BridgeSet/relevo K1 (§24), tipos del horizonte (§25) y unicidad nominal de Domain/ligaduras pendientes (§26), campos opcionales y relevo K1-T (§27), delimitación K1-T y salida acotada a F (§28), contrato candidato F y relevo F-IF (§29), campaña F-IF y relevo G/H (§30), y el acta de fase y las entradas RETP directamente aplicables;
...
- K1-T (IR 0.3 §2.4): declarar `Ternarizer` no prueba partición ni habilita producción observación → Tri. F recibe sus requisitos; cualquier futura ruta productiva debe cerrar antes las pruebas pendientes.
