...
## 5. Resultado material de la candidata · RETP-102

El contrato anterior quedó fijado en `66f22db1324411fbc40e8adf3a5f5f15c7b4d3d7`. La realización `bb23381ba63a0512180ffb80f849a7241520b4c8`, árbol `10101231bdc753516fb4f21155774508cbde46b5`, supera los cinco flujos; sus ejecuciones y artefactos están en [RETP-102 del maestro](../calidad/REGISTRO_EVOLUCION_TECNICA_PROYECTO.md#retp-102). La fusión virtual de CI `9ce6747562385c9201cb8835dc72253d7a07a619` conserva ese árbol. El flujo aislado obtiene directamente la cabeza material, sin utilizar la fusión virtual.

El paquete contiene 227 archivos Git literales y dos objetos de inventario. Dos preparaciones de ese corte dan el mismo SHA-256 `9f8cd42a400c1f908926735f2f82785b7bfd6423c1e0e6a9f1bbe64a7f9b268d`. Los cuatro controles negativos son rechazados por su causa. En el entorno aislado pasan 348 pruebas Rust del espacio de trabajo, incluida la documentación ejecutable; se regenera G/H sin diferencias y se ejecutan LIG, GH y ambos perfiles de la CLI. El negativo de posición cero da retorno 1, IR vacía y la causa comprometida. La construcción no accede a red ni a cachés anteriores y no dispone de intérpretes Python/Node. Las fuentes inventariadas conservan su huella después de las pruebas.

El observador externo, ejecutado con Node fuera del entorno aislado, recalcula las 48 huellas y detecta 28/28 ataques; conserva 16/16/16 transportes y ocho pérdidas H. La batería general mantiene 14/14 válidos, 106/106 inválidos, 43/43 mutaciones dirigidas detectadas y paridad literal nativa/WASI/navegador. No hay cambio del núcleo en RETP-102; la candidata completa sí contiene las 578 líneas incorporadas por #79/#80.

**Estado material: `CANDIDATA_COMPLETA_PARA_ADVERSARIAL_NO_PROMOVIDA`.** El objeto completo es `main@1706099…` hasta la cabeza final de [PR #83](https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/pull/83), con #79–#82 por ascendencia. Su cierre documental posterior no cambia los fuentes Rust ni las pruebas. Las comprobaciones de esa cabeza y su nuevo paquete, cuyo `CORTE_GIT.txt` cambia, se identifican en la PR. Este resultado satisface la preparación material de §4; quedan la auditoría externa fuerte y la decisión de entrega antes de CYB. `row7_closed=false`, Q0 y las doce SP conservan sus límites. No se otorga aprobación clínica ni se cierra globalmente la deuda de dependencias o de semántica.
