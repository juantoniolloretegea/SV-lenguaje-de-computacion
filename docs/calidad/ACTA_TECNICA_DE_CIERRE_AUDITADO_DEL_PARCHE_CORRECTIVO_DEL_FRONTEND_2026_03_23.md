...
La decisión se apoya en base de verificación real del repositorio operativo y, en particular, en:
...
En el estado auditado tras subida y contraste del árbol del repositorio verificado, la base ejecutable queda así:
