...
## 13. Consulta documental incorporada del manifiesto SV · 13/09/2026

Por instrucción expresa del autor se incorpora el [acta íntegra de prohibición de uso bélico y primacía de supervivencia humana](./ACTA_TECNICA_DE_PROHIBICION_ABSOLUTA_DE_USO_BELICO_Y_PRIMACIA_DE_SUPERVIVENCIA_HUMANA_EN_EL_SV_2026_03_26.md) como recurso de `sv_core`, incluido al construir sus realizaciones. El [contrato de consulta](./manifiesto-sv/CONTRATO.md) define las interfaces, la identidad literal, los fallos y las pruebas. La API y los comandos muestran ese recurso sin dependencia de red ni lectura del repositorio durante la ejecución.

La incorporación documental no añade una palabra reservada a SVP, un objeto de IR, una regla algebraica ni un clasificador de usos. Conserva el rango del texto español y el estatuto declarativo de la capa Rosetta. Disponibilidad del acta y ejecución de mecanismos de cumplimiento son obligaciones distintas; la primera no acredita la segunda. Las modificaciones futuras del acta deben actualizar de forma expresa el recurso, su huella y los oráculos en el mismo expediente, sin descarga ni sustitución silenciosa en ejecución. La consulta no sustituye los requisitos de integridad del artefacto y de confianza de plataforma. Registro RETP-2026-201; expediente y resultados en la sede de Calidad enlazada.


## 14. Fuentes de consulta sobre agentes especializados y aprendizaje trazable · 14/09/2026

Se incorporan al índice de consulta las siguientes fuentes de Juan Antonio Lloret Egea, conservando sus funciones y rangos propios:

- [Fundamentos, exigencias y arquitectura general de los agentes especializados en el Sistema Vectorial SV: formulación transversal desde el caso director del Agente Especializado en Inmunología](https://doi.org/10.21428/39829d0b.183e10f3), 12/04/2026. Referencia para la arquitectura de agentes, la separación de planos, la incorporación extrínseca, la cuarentena y la autorización humana. Su cláusula de anclaje exige la concurrencia del Estatuto, la Instrucción Técnica de Implementación específica, estos Fundamentos y la Carta Magna de autogobierno.
- [Aprendizaje trazable en inteligencia artificial: evolución estructural del conocimiento con frames ternarios y trazas acumulativas](https://doi.org/10.21428/39829d0b.bebc607c), 15/08/2026. Referencia para la evolución del conocimiento, la novedad histórica, los certificados de soporte y la preservación del fundamento bajo soberanía humana. Su recepción en el Lenguaje consta en el [acta de 15/08/2026](./ACTA_TECNICA_DE_RECEPCION_DOCTRINAL_Y_PRESERVACION_DE_CONTINUIDAD_DEL_APRENDIZAJE_TRAZABLE_HACIA_IR_N3_N4_2026_08_15.md) y en el [acta complementaria de 16/08/2026](./ACTA_TECNICA_COMPLEMENTARIA_DE_FIJACION_DE_FUENTE_DOCTRINAL_Y_PRESERVACION_PRE_DSL_DEL_APRENDIZAJE_TRAZABLE_2026_08_16.md).

Esta incorporación facilita la localización de fuentes existentes. La consulta documental conserva la distinción entre fundamento, contrato y realización acreditada establecida en estos Pilares. Las posibles tensiones entre fuentes deben declararse y resolverse por la autoridad competente; el índice no las resuelve ni sustituye la constitución particular de un dominio o agente.
