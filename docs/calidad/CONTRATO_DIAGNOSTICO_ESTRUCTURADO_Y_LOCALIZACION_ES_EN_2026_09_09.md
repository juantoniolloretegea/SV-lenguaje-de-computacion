...
## 10. RETP-111/112 — Integración del alcance previo e inventario sucesor

El 09/09/2026 el Director dispone: «Si lo que viene ahora no depende de PR#88 queda aprobada y seguimos». Comprobada la independencia funcional respecto de código productivo añadido por la candidata, se integra #88 en 73c738348a9493a459744c62b8ade382ff595af5, árbol 4827e8757ed2776e3f4f35f206ea3cb7bdb6e01e. La cabeza 6ac0bdc33ecbe568e11247232e45280c91ed3d4d tiene ese mismo árbol y seis flujos conformes. [RETP-111](REGISTRO_EVOLUCION_TECNICA_PROYECTO.md#retp-111) registra identidades, comprobación y alcance.

Esta decisión expresa aplica la alternativa de §8 a la integración del material ya verificado, incluidos los contratos previos. No acredita la realización diagnóstica ni modifica retroactivamente las condiciones anteriores. El trabajo siguiente sí recibe este contrato como obligación documental. La localización sigue pendiente y precede al enlace profesional R1; la observación productiva conserva el orden de §9.1. Las menciones históricas a #88 como candidata son sucedidas por este apartado.

El [inventario RETP-112](INVENTARIO_DE_EMISORES_DIAGNOSTICOS_Y_MIGRACION_ES_EN_2026_09_09.md) fija 15 archivos y 224 ubicaciones revisadas, diferenciando emisión, adaptación, salida y aserciones internas. Conserva causas tipadas/literales y parámetros en su lugar de emisión, y localiza pérdidas de procedencia. Es estático: no declara 224 causas alcanzables ni cierra el inventario dinámico por puerta pública. Antes de promover la realización, cada ubicación pertinente tendrá un caso o una exclusión justificada por guarda previa. No se inferirá doctrina de los textos existentes.

Se continúa con causas y parámetros estructurados, mapa de procedencia, plantillas ES/EN, migración de oráculos y versiones de transporte. DG01–DG14 y entrega visible permanecen pendientes; tampoco se atribuyen facultades ni una arquitectura profesional. Fila 9 y núcleo abiertos; dominios en pausa. Este apartado no añade código, APIs, dependencias productivas ni despliegue.

## 11. RETP-113 — Primer incremento frontal verificado

La [realización frontal](REALIZACION_FRONTAL_DE_PROCEDENCIA_Y_EXPLICACION_ES_EN_2026_09_09.md) incorpora causas y parámetros desde las guardas, procedencia de bytes originales y explicaciones ES/EN en el error devuelto por las entradas existentes. Los esperados se comprometieron en `5d6d15b0f9f189d31eede4c28e32391f91dd795a`; la realización `5627416505b119192423722e94a71a3137f1a17a` tiene árbol `488e588a16db189d3c681bd9b1b44226cd4d1518`, idéntico al checkout de CI comprobado. Se conservan seis flujos conformes, 376 pruebas Rust con siete nuevas, conformidad 14/106 y sensibilidad de las 43 mutaciones anteriores.

Esta recepción es parcial respecto del contrato completo: los casos nuevos comprueban la representación frontal en nativo CI; la paridad anterior conserva sus propias salidas. No acredita todavía el nuevo transporte diagnóstico por CLI/ABI, la localización de los emisores posteriores ni el playground de producción. La representación Rust de `FrontendError` y su acceso de lectura se declaran en la pieza sucesora; su `Debug` histórico se conserva temporalmente. No se publican otras entradas de admisión ni se interpreta prosa para decidir el juicio.

DG01–DG14 completos, DFL-001/011, emisores relacionales y de bienformación, migración de oráculos y presentación productiva siguen pendientes. La PR #89 permanece en borrador y el enlace profesional R1 no se inicia por este incremento. No cambian las constituciones IMM/CYB ni se acredita autoridad o seguridad material.
