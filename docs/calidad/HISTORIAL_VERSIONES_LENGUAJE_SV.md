...
| 24/08/2026 | Frontera Normativa v0 respecto de Gramática 0.2 / IR 0.3 | Reconciliación explícita de las cláusulas de admisibilidad, resolución y `Frame` que habían quedado superadas por C01–C03. | La Frontera Normativa v0 se conserva como antecedente; la adenda fija la precedencia vigente sin modificar los números de Gramática, IR o serializador. | [Adenda técnica de vigencia](../../ADENDA_TECNICA_VIGENCIA_FRONTERA_NORMATIVA_C01_C03_2026_08_24.md) |
