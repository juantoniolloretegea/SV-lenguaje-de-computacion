...
("STATE_CARDINALITY_PENDING_en","-- prólogo é: frame, fuente y fidelidad\r\n\tadmissibility_spec A { parameter_id: 1; states: {Ok, Degraded}; rule: R; }",P::En,"CD.INVALID_ADMISSIBILITY_STATE",None,"cbdb6fe1e0247cac1bd365f2d8e3889ede39a4679e35045064e5866c478da8fa"),
...
("STATE_CARDINALITY_PENDING_es","-- prólogo é: frame, fuente y fidelidad\r\n\tespecificación_de_admisibilidad A { identificador_de_parámetro: 1; estados: {Admitido, Degradado}; regla: R; }",P::Es,"CD.INVALID_ADMISSIBILITY_STATE",None,"0c855d99464568be561ce14e9c68c5576efb4ffb01787285ba75a9b06bea56a8"),
