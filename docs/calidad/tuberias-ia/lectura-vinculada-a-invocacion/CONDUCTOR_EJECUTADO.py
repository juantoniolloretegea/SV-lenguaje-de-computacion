...
import subprocess,os,json,hashlib,base64,time
root=Path.cwd();tmp=root/'tmp/continuidad-152';src=tmp/'candidata';out=root/'entregas/lectura-vinculada-a-invocacion';rust=root/'tmp/presentacion-150/toolchain/installed/bin/rustc'
