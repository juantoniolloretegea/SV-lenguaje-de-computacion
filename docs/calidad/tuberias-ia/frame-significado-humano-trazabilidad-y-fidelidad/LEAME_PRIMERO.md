...
**Requisito instrumental S23 / RETP-201:** [Rust nativo y manifiesto incorporado](../../manifiesto-sv/README.md). Rust 1.98.0 y Cargo 1.98.0 están instalados y ensayados en el entorno remoto de trabajo. Cargar el entorno de Cargo en cada consola antes de comprobar las versiones. La consulta `manifiesto-sv` incorpora el acta completa al construir y no necesita GitHub ni archivos externos en ejecución. La candidata conserva evidencia local; su promoción se consulta en el mismo expediente. El siguiente frente sustantivo sigue siendo S22/BIS-02.
