...
**Siguiente objeto material:** continuar BIS-C08: Tri.U válido y fallos técnicos de representación. [BIS-C07](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c07/README.md) fija composición de células de 16/25 posiciones, dirección, puente y tabla ordenada: 18 fixtures SVP preparados y cero ejecutados. Se separa estructura admisible de relación exacta exigida por la operación. El [criterio Rust](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c05/CRITERIO_DE_ACEPTACION_RUST_v1.md) exige compilación y recepción/validación reales; los oráculos Python no las acreditan. C01 conserva evidencia nativa; C02–C07 conservan sus estados previos y límites. Permanecen dos escenarios originales ejecutados y 22 pendientes. BIS-03 decide sedes y BIS-04 realiza lo justificado.
