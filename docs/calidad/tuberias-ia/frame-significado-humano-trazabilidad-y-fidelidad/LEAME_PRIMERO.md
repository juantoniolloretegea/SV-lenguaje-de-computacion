...
**Concordancia de estatutos, S22 / RETP-2026-198:** leer [Suceso, frame, representación y operaciones de biblioteca SV](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/CONCORDANCIA_SUCESO_FRAME_REPRESENTACION_Y_OPERACIONES_SV.md). El Documento III distingue sucesos y resultado de reevaluación; el V añade consulta trazable. El suceso, en la acepción general precisada por el autor, es un hecho factual; prosa e imagen son representaciones. Las actividades técnicas pueden registrarse sin frame, y la ocurrencia de una afirmación no acredita su contenido. Quedan por constituir la inicialización, la relación frame celular/arquitectónico y el estatuto material de frvis. Función, método o macro Rust no concede estatuto de primitiva. BIS-01 sigue en ejecución; no trasladar estas propuestas al núcleo como contratos ya cerrados.
