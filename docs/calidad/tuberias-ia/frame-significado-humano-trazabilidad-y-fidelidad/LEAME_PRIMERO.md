...
**Siguiente objeto material:** continuar BIS-C07: composición entre células de dimensiones diferentes, dirección, puentes y codominios. [BIS-C06](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c06/README.md) fija contrato de lectura, inicialización y reevaluación, con 18 escenarios especificados y cero ejecutados. La lectura técnica no exige Frame; la inicialización no inventa antecedente; la reevaluación requiere productor efectivo. La continuidad entre instantáneas se distingue de la bienformación local. Se mantiene el [criterio de aceptación Rust](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c05/CRITERIO_DE_ACEPTACION_RUST_v1.md): preparación Python, compilación y validación ejecutada son evidencias distintas. C01 conserva su contraste nativo; C02–C06 son contratos y bancos previos. Permanecen dos escenarios originales ejecutados y 22 pendientes. BIS-03 decide sedes y BIS-04 realiza lo justificado.
