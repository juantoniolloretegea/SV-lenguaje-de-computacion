...
**Siguiente objeto material:** materializar y ensayar en Rust el [montaje C02–C05 con sedes e interfaz fijadas](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis03-sedes-i0205-v0_1/README.md), RETP-219. Se elige un crate experimental separado sobre la API pública de sv_core, sin ampliar semántica/IR. Los [26 casos integrados de RETP-218](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/integracion-c02-c05-v0_1/README.md) permanecen intactos y sin ejecutar; se añaden 19 casos instrumentales previos para adaptar JSON y SHA. BIS-03 en ejecución acotada; BIS-02 global abierto y BIS-04 pendiente. Se conservan los conteos originales (2 ejecutados, 22 pendientes), las 202 filas previas C02–C12 sin ejecutar y las 13 variantes históricas C01. Rust/Cargo 1.98.0 recuperados en S25; S24 conserva la GUI diferida.
