...
S26 continúa por el [banco previo F01/F02 de referencias y ligaduras](../../riesgos-materiales-s26/r06/BANCO_F01_F02_LIGADURAS.md): diez casos Rust, dos entradas por caso y dos perfiles. El entorno Rust/Cargo 1.98.0 se ha recuperado; el [ajuste previo de invocación](../../riesgos-materiales-s26/r06/AJUSTE_INVOCACION_F01_F02_LIGADURAS.md) utiliza las rutas de la instalación directa, sin modificar los casos ni sus oráculos. Los árboles completos de entrada han sido cotejados con R08. Sucesos S26 revisión 24 registra la preparación; todavía no acredita ejecución del banco. Consulta histórica y resolución completa por Frame siguen pendientes. No repetir INTEGRADO01 ni los bancos recibidos.
