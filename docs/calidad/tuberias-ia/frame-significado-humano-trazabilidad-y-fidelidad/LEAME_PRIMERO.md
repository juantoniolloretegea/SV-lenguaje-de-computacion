...
**Siguiente objeto material:** continuar BIS-C10: justificación suficiente y relación afirmación–evidencia. [BIS-C09](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c09/README.md) fija contenido frente a autoridad: veinte escenarios, once documentos sintéticos y cero ejecutados. La entrada no amplía permisos ni cambia por sí sola objeto, contexto, destino o regla de despacho. Recepción determinista, conducta de un modelo y contención del efecto tienen evidencias distintas. El [criterio Rust](../paridad-imagen-celula-matematica/estudio-nucleo-agentes/bis-c05/CRITERIO_DE_ACEPTACION_RUST_v1.md) continúa vigente. C01 conserva evidencia nativa; C02–C09 mantienen estados y límites. Permanecen dos escenarios originales ejecutados y 22 pendientes. BIS-03 decide sedes y BIS-04 realiza lo justificado.
