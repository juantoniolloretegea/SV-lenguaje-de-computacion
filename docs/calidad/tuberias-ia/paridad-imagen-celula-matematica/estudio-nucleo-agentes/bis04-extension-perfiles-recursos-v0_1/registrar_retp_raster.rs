//! ES: Incorpora RETP-240/241 con control de sucesión y prefijos intactos.
//! EN: Adds RETP-240/241 with sequence control and intact historical prefixes.
#![forbid(unsafe_code)]
#[allow(dead_code)]
...
fn main(){
 ...
 assert!(matches!(fields[0].as_str(),"RETP-2026-240"|"RETP-2026-241"));
