...
La [concordancia documental](CONCORDANCIA_SUCESO_FRAME_REPRESENTACION_Y_OPERACIONES_SV.md), S22 / RETP-2026-198, contrasta los Documentos III y V, la especificación metodológica de frames, la nota de suceso local/envolvente, la IR 0.3 y el anexo SEC5. Recibe la precisión del autor: suceso como hecho factual; prosa y gráfico como representaciones según necesidad. Distingue actividad técnica, tipo del horizonte, suceso instanciado, resultado de reevaluación, consulta y representación. Registrar que una IA emitió una afirmación no acredita su contenido.
