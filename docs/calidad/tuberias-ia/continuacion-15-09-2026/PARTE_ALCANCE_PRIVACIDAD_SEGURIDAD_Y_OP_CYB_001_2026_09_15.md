...
<a id="s32-recepcion-memoria-traza-2026-09-17"></a>

## 17. Recepción parcial del complemento de traza y memoria · 17/09/2026

**Seguimiento:** S32 revisión 9 / RETP-2026-258. **Actualización UTC:** 2026-09-17T19:32:41Z. **Unidad:** W-S32.

La [recepción privada y sus evidencias](https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/f65b7b1aeceed24714e78c4e3d4ce4a1cec89f94/watson-herramientas/evidencias/receptor-memoria-traza-03-20260917/ACTA_RECEPCION.md) registra reconstrucción en una instancia Linux nueva con Rust 1.98.0, --locked --offline y dependencias previamente recibidas. Se recuperaron 727 archivos del nuevo producto; 726 identidades de manifiesto y 34 de precompromiso permanecieron concordantes antes y después. Nueve casos MT01–MT06/MM01–MM03 concordaron con los oráculos publicados. Las ejecuciones Windows/WSL2 conservan atribución productora. Este resultado es distinto del banco anterior de 19 casos y de los 19 TLC, que siguen sin ejecutar. No se acredita aislamiento de red impuesto por el sistema operativo.

RCR-01 queda resuelta exclusivamente como desajuste del estímulo de omisión: MT02 y MT03 suprimen respectivamente un evento requerido, conservan el resto y producen los rechazos previstos, diferenciando cobertura de estructura. El caso histórico CR08 no se reescribe. La composición puede admitir una traza completa de operación interrumpida sin declarar éxito de la operación. No se demuestra toda omisión, orden o multiplicidad posible ni se añaden requisitos al contrato. RCR-02 conserva sus límites históricos; RCR-03 mantiene su resolución previa.

MM01–MM03 acreditan valores propietarios y recorridos finitos de error conformes. No acreditan ausencia universal de punteros colgantes, fugas ni errores ABI. La FFI nativa continúa dentro del proceso auxiliar; la prohibición de unsafe en el código propio no verifica sus dependencias. No se activaron sanitizadores ni se reconstruyó el motor nativo. **La observación bajo depurador no se realizó**, por bloqueo de inicio del editor; el mapa de propiedad sigue siendo documental. No se ha establecido relación causal con la excepción de la aplicación comunicada por la Dirección.

El registro productor muestra intentos de escritura y eliminación sobre almacenamiento compartido del editor fuera del directorio de ensayo. Los errores conservados no demuestran que esas operaciones se consumaran; impiden acreditar el aislamiento local del editor. También documenta ExecutionPolicy Bypass, cuya autorización específica no puede acreditarse con el expediente recibido. Debe identificarse la autoridad aplicable si existe; no se presume ausencia de autorización externa al expediente ni cambio permanente de política. La aclaración del perímetro y de esa excepción precede a cualquier nuevo intento de depuración; no se autoriza reparación global, elevación ni ampliación de rutas por este asiento.

Se cotejaron árboles completos por progenitor de cinco commits privados: cd9b3c9, 129e005, 4cfa358, 148b39e y 8404a26. Los cambios del producto y de administración concuerdan con las rutas del encargo; la conciliación conserva documentos receptores concurrentes. Este cotejo no acredita todas las escrituras locales ni la autorización de toda la historia. El auditor publicado concuerda en su intervalo EV1–EV212: 212 eventos/huellas, 80 fragmentos y ocho parches; no se extiende a eventos posteriores ni acredita observación independiente exhaustiva.

**Aceptación parcial y sin integración.** AUX-C01–C04 y permisos por dominio, finalidad y expediente permanecen pendientes. La inmunología y la ciberseguridad conservan sus necesidades y restricciones propias; agregados y consultas no otorgan autorización de salida. S32/BIS-03 abiertos, H2 candidato, durabilidad no implementada y 19 TLC sin ejecutar. No se habilitan núcleo, Qwen, interfaz, NCBI, federación ni datos reales.

Esta instantánea sucede a la revisión 8, preserva sus asientos y los otros 36 sucesos, y concilia Sucesos, RETP, este parte y los dos accesos. No modifica productos, ramas, permisos ni espejos públicos. El siguiente paso es aclarar los pendientes procedimentales y delimitar una eventual continuación bajo la autorización humana vigente.
