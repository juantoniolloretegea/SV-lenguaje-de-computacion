...
- **Precisión diagnóstica pendiente:** `E006 — UndeclaredReference` se utiliza tanto para una referencia inexistente como para una referencia existente de tipo incompatible. La función es efectiva, pero el nombre y el mensaje base describen con mayor precisión el primer supuesto.
...
- **Estado:** gobernada; no bloquea el cierre de FFL-B.
- **Prioridad:** alta para una futura revisión del contrato diagnóstico, no para reabrir FFL-B por sí sola.
...
- **Estado:** abierta como obligación de mantenimiento documental; no bloquea FFL-B.
...
- **Estado:** reconocida; fuera del alcance cerrado de FFL-B.
- **Prioridad:** posterior y dependiente de decisión arquitectónica expresa.

## 3. Estado de FFL-B

FFL-B se cierra tras E215 porque las obligaciones restantes identificadas no pueden materializarse de forma honesta mediante una comprobación estructural adicional sin ampliar representación, semántica o ejecución.
