...
**fecha_alta_utc:** 2026-09-13T20:52:22Z

**fecha_inicio_utc:** —

**fecha_actualizacion_utc:** 2026-09-13T20:52:22Z

**fecha_fin_utc:** 2026-09-13T20:52:22Z

**unidad_responsable:** Watson / W-S0

**alcance:** Explicación autorizada en expedientes del volcán y tres realizaciones Rust; reparto de autoridad y orden de trabajo. Sin constitución clínica ni motor de rutas.

**repositorios_y_ramas:** SV-lenguaje-de-computacion: main; SV-matematica-semantica-cuaternaria: lab/playground-sv-permanente

**cortes_de_entrada:** Lenguaje 531010ab56298605f4f2469554a9f48420ffa4a9; laboratorio b2cd1ab66b66d91578c621e5ee37a6a48bb5e020; Inmunología dominio-inmunologia fe8adf76aa030ba5ff4997be5772b5de5e4452f3

**dependencias:** Petición humana; rectores y relevo OP-IMM-001; contrato inmunológico v0.3 y G7-RUT; continuidad material S26.

**resultado:** Sección 11 añadida al PDF/MD del volcán; complemento en PDF/MD de tres realizaciones Rust; entrada destacada en Léame primero. Primero dominio y sus unidades; Lenguaje continúa S26 y preserva antecedentes de rutas.

**verificacion:** Prefijos Markdown preservados; texto y render de las 30 páginas anteriores idénticos; tres páginas nuevas inspeccionadas. Código, texto íntegro de incorporación y huellas conservados. Publicación y espejo sujetos al cotejo de árbol del publicador.

**evidencias:** https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/frame-significado-humano-trazabilidad-y-fidelidad/LEAME_PRIMERO.md

**referencia_calidad:** RETP-2026-230

**siguiente_accion:** Continuar S26: salidas sin recibo, interrupción/pánico y sustitución de fuente durante lectura. Retomar cobertura de rutas en sede del dominio y agente cuando corresponda.
...
**alcance:** Evaluación y acta aprobadas, ampliaciones Markdown y acceso humano en Word como alternativa expresamente autorizada a los PDF. IA de lenguaje probabilístico auxiliar; consejo trazable y decisión clínica humana.
...
**fecha_actualizacion_utc:** 2026-09-15T08:49:43Z
...
**resultado:** C01–C05 concluidos. Recepción C03: ambos archivos recuperados; ZIP S6 con identidad y CRC conformes. Complemento: 482 huellas de controles y 2410 campos compartidos con el informe público concordantes; identidad individual del generador declarada sin atribuir precompromiso. Exposición de la referencia comunicada por una unidad revisora: condición documentada para una eventual reutilización evaluativa de S6. Contrato R06 pendiente de subsanación.

**verificacion:** Rust 1.98.0: cotejo del ZIP y de tres entradas públicas fijadas; 482/482 huellas, 2410/2410 campos compartidos, 482/482 esperado-observado consignados, 17 familias y 2/2 huellas CLI. Generador 8588 bytes, SHA-256 52684359885d5e84a2a94d9ccc46cd99fb1e915bfa9fbcff42c5472a71717a56. Referencia coincidente con compromiso. Sin ejecución de programas históricos. Exposición recibida como declaración, no acceso observado directamente.

**evidencias:** docs/calidad/tuberias-ia/continuacion-15-09-2026/PARTE_S31_CORRECCION_ACOTADA_Y_TRAZABILIDAD_2026_09_15.md; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31.rs; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31_SALIDA.txt; docs/calidad/tuberias-ia/continuacion-15-09-2026/ENTRADAS_S31.tsv; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31_RECEPCION_ZIP_S6.rs; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31_RECEPCION_ZIP_S6_SALIDA.txt; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31_CONTENIDO_S6.rs; docs/calidad/tuberias-ia/continuacion-15-09-2026/COTEJO_S31_CONTENIDO_S6_SALIDA.txt
...
**siguiente_accion:** Retomar la subsanación del contrato candidato de leyenda R06. Antes de reutilizar S6 como evaluación, determinar las exposiciones a la referencia y la admisibilidad de cada participación. Mantener las condiciones previas de P3.
...
**fecha_actualizacion_utc:** 2026-09-17T19:32:41Z

**fecha_fin_utc:** —

**unidad_responsable:** W-S32

**alcance:** Correspondencia de flujos y obligaciones de privacidad/seguridad; contratos y puertas de habilitación. Recepción instrumental del complemento de traza y memoria del cliente Rust, sin integración en el núcleo.

**repositorios_y_ramas:** SV-lenguaje-de-computacion: main (registro canónico); SV-sala-de-maquinas: main (evidencias privadas). Laboratorio público sin modificación.

**cortes_de_entrada:** Lenguaje bdb094958da5be00d2c24864c333deaa4f0636cc; encargo 48678aee1123796876bedc19967edb54aed47665; entrega AUX-MEMORIA-TRAZA-03 8404a26ac7966f7162ba635d9b7f38b0e75874f1; producto 148b39edbeeeaa019e4f3535823dc589c67b1c8f; recepción f65b7b1aeceed24714e78c4e3d4ce4a1cec89f94. Antecedentes en historial.

**dependencias:** S22 / BIS-03; RETP-2026-242/243; RS01–RS12 y adenda §12 de OP-CYB-001; rutas S28; obligación instrumental S29.

**resultado:** Recuperación receptora Linux: nueve casos concordantes. RCR-01 resuelta sólo para el desajuste de omisión exacta mediante MT02/MT03; sin completitud universal. RCR-02 histórica y RCR-03 resuelta conservadas. Aceptación parcial; depuración no realizada y reservas de procedimiento local pendientes. S32/BIS-03 abiertos; H2 candidato y 19 TLC sin ejecutar.

**verificacion:** 727 archivos recuperados; 726 entradas de manifiesto y 34 de precompromiso concordantes antes y después. Rust 1.98.0 --locked --offline con dependencias previamente recibidas. Auditor: 212 eventos/huellas, 80 fragmentos y ocho parches dentro del corte declarado. Cinco commits cotejados por árboles completos. Windows conserva atribución productora. Sin demostrar aislamiento de red del sistema operativo ni seguridad general de la FFI.

**evidencias:** https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/f65b7b1aeceed24714e78c4e3d4ce4a1cec89f94/watson-herramientas/evidencias/receptor-memoria-traza-03-20260917/ACTA_RECEPCION.md (acceso restringido). Parte §17: recepción, límites, perímetro y seguimiento.

**referencia_calidad:** RETP-2026-258; parte de privacidad §17. RETP-2026-254/255/256/257 e historial preservados.

**siguiente_accion:** Aclarar el perímetro efectivo de almacenamiento del editor y la autorización de la excepción de ejecución documentada antes de otra observación bajo depurador. Mantener AUX-C01–C04 y permisos por dominio/finalidad/expediente pendientes. Cualquier continuación material requiere encargo acotado transmitido por la Dirección.

**observaciones:** Revisión 9. Alta/inicio/unidad preservados; fin vacío. El registro productor muestra intentos de escritura/eliminación fuera del directorio de ensayo; no demuestra que se consumaran. La autorización específica de ExecutionPolicy Bypass no está acreditada en el expediente recibido; no se atribuye cambio permanente. Sin aceptación íntegra, producción, NCBI, núcleo, interfaz ni sincronización de espejos.
...
**fecha_actualizacion_utc:** 2026-09-24T17:58:17.005Z

**fecha_fin_utc:** —

**unidad_responsable:** Unidad de ejecución experimental S39

**alcance:** Investigación lateral acotada de (p1+P3)-Bis, procedente de la adenda de integridad del consejo asistido por IA de OP-CYB-001. Obtiene evidencia material sobre Qwen, Candle, observabilidad y control para determinar necesidades de representación, contratos o soporte del Lenguaje, con gramática 0.2 e IR 0.3. No prescribe cambios del núcleo ni constituye integración productiva. Vía B nativa como continuación inmediata; vía A navegador/WebAssembly para contraste posterior. Recepción del diagnóstico gpt-oss-20b/mistral.rs y recuperación material en OneCloud, con respuesta aritmética correcta de la candidata y contraste adverso del ejecutable anterior en el mismo anfitrión.
...
**cortes_de_entrada:** Recepción revisión 6: Lenguaje main 9b2e5ef0aa1ea010a7cc79a2a67df7017bd99bc7; SV-motor 484acafebd5ec0bcedb759e2423ae935e7feb1a1; adenda OP-CYB-001 en SVperitus-dataset bbac1b44b1d3b845305e9cde492a08221206d631. Interrupción instrumental fae1add308dcf7079e3d46e7a0c969716139d26f y examen del medidor 10484cf7a6bd5ae5fd4a132e0aeb6ab6ec58044e. REGISTRO.json de instalación 22/09/2026, SHA-256 39620112319836ee5603127f7fc95bfa9fc04035fec8c83fd1e98db63bcb2144. Revisiones 0–5 conservadas. Recepción técnica revisión 7: Lenguaje 62780b71c7c7c545b1b163ab9a8c0f33eade760e; fuentes de conversación SV-motor eec0d87fd9e41a3341b799540bb4545c6dd686d9; exportaciones y lectura directa del registro de ejecución identificadas en TT-0001–TT-0006. Recepción de entrega Beta: Motor 5eaaa2c151f039c58ebd8f5746784bbe9b00a252; Lenguaje 91e1cd38fa2e5d1bb237c2e10620104325bdd448; documento OP-IMM-001 en Peritus bba2d3ae24cdc20e33b90375f295916928011985. Entrega publicada: SV-motor a14ea31b3903d49a98f08b912206b1c8c9eeaf74; protocolo previo daa0f5f0170055bcdf4d2760ccf576013316fce9. Ejecutable 0.1.3 SHA-256 3b29ef59d82145575d5efaba1ec76e50c70bf4a576e2d13008fa3baf6de70e61. Delimitación posterior: Motor a14ea31b3903d49a98f08b912206b1c8c9eeaf74 y Lenguaje a875a5f74505045855bfbd56449f4c2522b457e7; CAPACIDAD-CGROUP-01 ejecutada el 22/09/2026 a las 19:04:03 UTC. Recepción del 23/09/2026: Lenguaje 0657bee85fdf036181478550cedebd0d48229dde; auditoría externa sobre el corte 41c99e2 y corrección posterior 4fafb8c diferenciadas; fuentes y verificación local recibidas en SV-motor 8cddcc83359bf6733a360d5bba2cd72426f8b631. Continuación material: Lenguaje c8aef9523a7c9083d7ee783290f429f33c4d38ae; Motor bf488a86dcb1a311ddf4355345e267901adad7c9 y fuentes de supervisión 8cddcc83359bf6733a360d5bba2cd72426f8b631. Resultados posteriores publicados en Motor 810a476488deb8dfb22585a51c91aee89d75ba0c. Rectificación posterior publicada en Motor 250c3e27784d36f347e9ac0aefa5b53e6cc46c98; recepción sobre Lenguaje 2faf9e8fda7de4a615ccbedaf3e06773b4d4fe5b. Ventana acotada: Motor ae9ceaef37e18d9cc12e25ea0369e4ebf58d9fb8; recepción sobre Lenguaje 3db44dfe1fd0aded365038cd24d67e2fcc7dfe80. Recepción GGUF: Motor f3746b719a3e355d75ea566d3d3abde2b6ea9e0e; Lenguaje 17228e1ccd3869035193e8dd47675eed35ba5524. Recepción revisión 16: Lenguaje d19bb1b33d5dea39926c1861aab5198e9556f186; Motor f3746b719a3e355d75ea566d3d3abde2b6ea9e0e; informe Motor a74632b0b6dde70629863113134082dc3f31d521; observación remota 2026-09-24T11:00:05Z. Recepción revisión 17: Lenguaje c68020992d19b041574992355de023961f6713d6; protocolos Motor 9a90884f9e537cffc7929c6b3518ece971728343 y c2e7695fabc40685ae712790e4a31d2e9ab9f631; resultados Motor 70750a516001cf13314176c529508d0712b7f3c1. Recepción revisión 18: Lenguaje 32bf520f6e6c63dae84ef299957b6fd0b8c20402; protocolo Motor 7a3a353f55f8fddf5898eae9c82feb2caeac4677; originales daa3d3ec10d7f77e52572704832e76fdd87d3e10; informe Motor d4e62b29713a2044be0d1d4a7fb463155d3999c3. Recepción revisión 19: Lenguaje 13e5becc550b731327ff33e291f79d884eee4b9b; protocolo Motor eab99127a1ef1a8062f3c9310a263887906a8133; fuentes 032ef13602ae9288cdd8467335c34198dda08871; informe parcial Motor dd4beaf5cf59c4114925fdece05bfe7885190395. Recepción revisión 20: Lenguaje 28879943c8f403fe63d29f032f7c569bdfd8aafb; Motor eafaf3711df15f4fca289d156e7333576144455a. Recepción revisión 21: Lenguaje a85d4d36b952360c7b53c3bc9f519f78a545d784; Motor a98825f24c7865a80e9aa35d6915c4ac93abdd04.

**dependencias:** Pilares; perfiles y contratos; transición secuencial; OP-CYB-001 §12; programa (p1+p3)-Bis v2; acta de rutas 14/09; Acta 001 §§2–4 y 10; EIO-CONTRATO-01/1. S22 y S32 conservan sus alcances; S37, S38 y S40 permanecen diferenciados y diferidos.

**resultado:** M01–M04 y cuatro condiciones L correctas en contenido; D01–D04 correctas y cuatro pendientes por plazo. DOC01–DOC04 conformes frente a cero conformes estrictas de Qwen, con condiciones diferentes. R02-01 parcial conservada; R02-02 en continuación. Servicio 0.2.3 y URL privada activos.

**verificacion:** VERIFICACION_ACOTADA: 22 pruebas Rust 1.98.0 aprobadas; reproducción del desbordamiento, preservación íntegra y exportación acotada; binarios cotejados; recepción de JSON originales y trazas cerradas. Comparación documental reproducible; sin certificación clínica ni causalidad exclusiva del modelo.

**evidencias:** https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/ACTA_004_FINALIDAD_ALCANCE_Y_CONTINUIDAD_EIO_2026_09_22.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/S39_RECEPCION_DOCUMENTAL_INSTALACION_2026_09_22.json ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/fae1add308dcf7079e3d46e7a0c969716139d26f/respuestas-ejecucion/EIO-GITHUB-01/entrega-04/controles-nativos-01/revision-04/RESPUESTA.md ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/10484cf7a6bd5ae5fd4a132e0aeb6ab6ec58044e/watson-herramientas/evidencias/cualificacion-medidor-20260921/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/inicio.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/json/EIO_2026-09-22_revision-01.json ; https://github.com/juantoniolloretegea/SV-motor/blob/eec0d87fd9e41a3341b799540bb4545c6dd686d9/laboratorio/ensayo-ia-y-observabilidad/conversacion-nativa/REVISION_SESION_2026_09_22.json ; https://github.com/juantoniolloretegea/SV-motor/releases/tag/eio-conversacion-v0.1.3-beta.1 ; https://github.com/juantoniolloretegea/SV-motor/blob/a14ea31b3903d49a98f08b912206b1c8c9eeaf74/laboratorio/ensayo-ia-y-observabilidad/resultados/consulta-documental-01/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/json/ENTREGA_BETA_Y_DOC01_2026-09-22.json ; https://github.com/juantoniolloretegea/SV-motor/blob/511969f4ba576734f4bf96e39eed3e90d5dd02d5/laboratorio/ensayo-ia-y-observabilidad/resultados/capacidad-cgroup-01/README.md ; https://github.com/juantoniolloretegea/SV-motor/blob/511969f4ba576734f4bf96e39eed3e90d5dd02d5/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/README.md ; https://github.com/juantoniolloretegea/SV-motor/blob/8cddcc83359bf6733a360d5bba2cd72426f8b631/laboratorio/ensayo-ia-y-observabilidad/resultados/cierre-qwen-b-20260923/INFORME.md ; https://github.com/juantoniolloretegea/SV-motor/blob/8cddcc83359bf6733a360d5bba2cd72426f8b631/laboratorio/ensayo-ia-y-observabilidad/conversacion-nativa/verificacion-0.1.4/INFORME.md ; https://github.com/juantoniolloretegea/SV-motor/blob/8cddcc83359bf6733a360d5bba2cd72426f8b631/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/controlador-nativo/verificacion-0.1.1/INFORME.md ; https://github.com/juantoniolloretegea/SV-motor/blob/810a476488deb8dfb22585a51c91aee89d75ba0c/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/continuacion-2026-09-23/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/TT-0012.md ; https://github.com/juantoniolloretegea/SV-motor/blob/250c3e27784d36f347e9ac0aefa5b53e6cc46c98/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/continuacion-2026-09-23/RECTIFICACION_CONTROLADOR.md ; https://github.com/juantoniolloretegea/SV-motor/blob/ae9ceaef37e18d9cc12e25ea0369e4ebf58d9fb8/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/mxfp4-2026-09-23/RESULTADO.md ; https://github.com/juantoniolloretegea/SV-motor/blob/f3746b719a3e355d75ea566d3d3abde2b6ea9e0e/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/gguf-2026-09-23/RESULTADO.md ; https://github.com/juantoniolloretegea/SV-motor/blob/a74632b0b6dde70629863113134082dc3f31d521/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/recuperacion-onecloud-2026-09-24/INFORME.md ; https://github.com/juantoniolloretegea/SV-motor/blob/70750a516001cf13314176c529508d0712b7f3c1/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/onecloud-2026-09-24/RESULTADO.md ; https://github.com/juantoniolloretegea/SV-motor/blob/d4e62b29713a2044be0d1d4a7fb463155d3999c3/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/resultados/onecloud-2026-09-24/optimizacion/RESULTADO.md ; https://github.com/juantoniolloretegea/SV-motor/blob/dd4beaf5cf59c4114925fdece05bfe7885190395/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/conversacion/RESULTADO_PARCIAL.md ; https://github.com/juantoniolloretegea/SV-motor/blob/eafaf3711df15f4fca289d156e7333576144455a/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/conversacion/CONTINUIDAD.md ; https://github.com/juantoniolloretegea/SV-motor/blob/a98825f24c7865a80e9aa35d6915c4ac93abdd04/laboratorio/ensayo-ia-y-observabilidad/modelos-de-ia/openai/gpt-oss-20b/conversacion/INCIDENCIA_EXPORTACION.md

**referencia_calidad:** S39 revisión 11; Acta 004 §11; TT-0011, recepción de correcciones locales y cierre delimitado de Qwen/B. TT-0002, TT-0003, TT-0004 y TT-0006 finalizados con limitaciones; TT-0001, TT-0005 y TT-0007–TT-0009 conservan sus resultados. S42/TT-0010 mantienen pendiente la instalación en PC. No se modifican contratos, semántica, IR, núcleo ni criterios de aceptación. S39 revisión 12; TT-0012 abierto; Acta 004 §12. Qwen/B conserva su cierre delimitado de la revisión 11. S39 revisión 13; TT-0012 abierto; Acta 004 §13. La rectificación de cuantización y supervisión prevalece sobre las interpretaciones de la revisión 12; originales conservados. S39 revisión 14; TT-0012; Acta 004 §14. S39 revisión 15; TT-0012 en ejecución; Acta 004 §15. S39 revisión 16; TT-0012 abierto; Acta 004 §16; RETP-2026-269; PTA-2026-011; Motor PTA-SVM-002. S39 revisión 17; TT-0012 finalizado con alcance limitado; Acta004 §17; RETP-2026-270; PTA-2026-012; Motor PTA-SVM-003. S39 revisión 18; Acta004 §18; RETP-2026-271; PTA-2026-013; PTA-SVM-004. S39 revisión 19; Acta004 §19; RETP-2026-272; PTA-2026-014; PTA-SVM-005. S39 revisión 20; Acta004 §20; RETP-2026-273; PTA-2026-015. S39 revisión 21; Acta004 §21; RETP-2026-274; PTA-2026-016.

**siguiente_accion:** Concluir o delimitar R02/R01 dentro del vencimiento 19:52:28 UTC; recibir originales, comprobar la telemetría real posterior a la corrección, evaluar respuestas y disponibilidad libre de la interfaz; conservar pendientes documentales y de integración.

**observaciones:** Tres exportaciones equivalen a dos rondas distintas y once preguntas. R02-01 excedió la cota de traza por duplicación de respuesta; guardia bloqueó R02-02. Corrección conserva cotas y original. Error de ruta del guion corregido antes de inferencia, sin extender ventana. Plazo por petición ampliado de 600 a 900 s y documentado. Sin nuevas compras ni ramas.
...
**dependencias:** Disposición de la Dirección del proyecto del 20/09/2026; Pilares; perfiles/contratos; transición secuencial; Fase 003; RETP-115–142 y sucesores; acta lingüística RETP-121; acta de rutas S28. S37 (contraste de varias IA), S38 (encapsulación) y S39 (EIO) conservan objetos y estados distintos. No se añade una condición previa al encargo EIO vigente.
...
**verificacion:** Fuentes y antecedentes según revisión 0. Corrección editorial de denominaciones conforme a Acta 001 §10.4; concordancia de S40 revisión 1 en CSV/Markdown/historial y RETP-2026-261. Filas previas preservadas. Sin ejecución experimental ni nueva secuencia aprobada.
...
**referencia_calidad:** Documento S40, versión 0.1.1, §§2–12; RETP-2026-260 y RETP-2026-261; Acta 001 §10.4. Fuentes conservadas en sus cortes.
...
[Ficha individual](fichas/S42.md) · [TT-0010](../tiques-tecnicos/TT-0010.md)
