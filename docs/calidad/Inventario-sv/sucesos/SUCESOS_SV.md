...
**fecha_actualizacion_utc:** 2026-09-22T18:00:00Z
...
**resultado:** Publicada EIO conversación 0.1.3 · Beta 1 para Linux x86-64, con ejecutable, fuentes, prospecto técnico, composición de 179 paquetes Cargo, licencias y evidencias. El manifiesto enumera 394 archivos; los pesos y el tokenizador se obtienen separadamente mediante referencias y huellas fijadas. El modelo se identifica como Qwen3-0.6B Q4_K_M. DOC-01 completó cuatro peticiones independientes, todas con finalización normal y ninguna conforme al contrato estricto. Se distinguen incumplimiento de formato, rechazo de información disponible y respuesta improcedente. TT-0007 y TT-0008 quedan finalizados en su alcance. S39 continúa en ejecución; los resultados y límites anteriores se conservan en el historial y en sus tiques.

**verificacion:** Cotejo en Rust 1.98.0 de tamaños y SHA-256 de los 394 archivos enumerados. Siete adjuntos publicados, con estado uploaded y huellas concordantes. Banco DOC-01 compilado con Rust/Cargo 1.98.0 y dependencias fijadas; una prueba del verificador con siete comprobaciones superada. Cuatro inferencias, sin repeticiones: retorno cero y fin de canal confirmado. Ocho trazas del banco sin errores ni descartes declarados; 62 muestras antes del cierre y 63 en el estado final del observador. No se repitieron los bancos históricos. Concordancia de S39 revisión 9 en CSV, Markdown e historial, y de TT-0007/TT-0008 con sus evidencias.

**evidencias:** https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/ACTA_004_FINALIDAD_ALCANCE_Y_CONTINUIDAD_EIO_2026_09_22.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/S39_RECEPCION_DOCUMENTAL_INSTALACION_2026_09_22.json ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/fae1add308dcf7079e3d46e7a0c969716139d26f/respuestas-ejecucion/EIO-GITHUB-01/entrega-04/controles-nativos-01/revision-04/RESPUESTA.md ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/10484cf7a6bd5ae5fd4a132e0aeb6ab6ec58044e/watson-herramientas/evidencias/cualificacion-medidor-20260921/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/inicio.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/json/EIO_2026-09-22_revision-01.json ; https://github.com/juantoniolloretegea/SV-motor/blob/eec0d87fd9e41a3341b799540bb4545c6dd686d9/laboratorio/ensayo-ia-y-observabilidad/conversacion-nativa/REVISION_SESION_2026_09_22.json ; https://github.com/juantoniolloretegea/SV-motor/releases/tag/eio-conversacion-v0.1.3-beta.1 ; https://github.com/juantoniolloretegea/SV-motor/blob/a14ea31b3903d49a98f08b912206b1c8c9eeaf74/laboratorio/ensayo-ia-y-observabilidad/resultados/consulta-documental-01/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/json/ENTREGA_BETA_Y_DOC01_2026-09-22.json

**referencia_calidad:** S39 revisión 9; TT-0007 (entrega Beta) y TT-0008 (consulta documental), finalizados con alcance explícito. Acta 004 y RETP-2026-268 conservan su carácter de antecedentes. TT-0001–TT-0006 mantienen sus estados y resultados. No se emite conformidad clínica ni integral de la vía B.

**siguiente_accion:** En el paso posterior, revisar la correspondencia entre las evidencias de esta lateral, la adenda OP-CYB-001 y las necesidades de (p1+P3)-Bis, semántica e IR. Identificar controles realizados, pendientes y previstos antes de proponer nuevas prestaciones. La consulta documental requiere aceptación verificable fuera del modelo; este ensayo no la incorpora a la conversación interactiva ni cierra el universo OP-IMM-001.

**observaciones:** La entrega fija una versión distribuible; su publicación no implica que un servicio permanezca activo. La campaña utilizó un banco independiente de los expedientes de usuario y mantuvo el ejecutable de conversación. Los cuatro objetos JSON se recibieron dentro de delimitadores Markdown y fueron rechazados conforme al criterio previo. La valoración descriptiva posterior no modifica ese criterio. DOC03 citó una oración existente, aunque improcedente para la petición: no demuestra fabricación de citas ni ejecución de instrucciones hostiles. El texto íntegro de la bibliografía no se declara disponible. La observación tiene cobertura acotada y no acredita aislamiento. No se acredita aptitud clínica, determinismo ni conformidad integral de la vía B. No se habilitaron gastos ni se modificaron núcleo, IR o dominios.
