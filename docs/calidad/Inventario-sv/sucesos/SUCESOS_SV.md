...
**fecha_actualizacion_utc:** 2026-09-22T17:23:56Z
...
**resultado:** La recepción documental de instalación de la revisión 6 conserva su alcance histórico. Posteriormente se dispuso de conversación nativa y acceso del titular tras autenticación. Se han revisado nueve turnos exportados y el cierre directo de una décima petición léxica: 514,90 s, primera salida a 435,68 s, 1 899 unidades de entrada, 220 de salida y fin normal. El modelo instalado es Qwen3-0.6B Q4_K_M, distinto de Qwen3.8-Max. Se identifican fallos de fidelidad y pertinencia, demora creciente y límites de observación. El tratamiento se distribuye en seis tiques vinculados, sin nuevos sucesos por cada defecto. La corrección 0.1.1 de licencias y metadatos se ha compilado y puesto en servicio; la aceptación visual y de una nueva exportación permanece pendiente. Las limitaciones históricas y el contraste de la vía A conservan su estado. Se inicia la constitución de una entrega Beta de la aplicación 0.1.3 y un ensayo documental acotado; todavía sin resultados de este ensayo ni publicación de la entrega.

**verificacion:** Cotejo estructural de exportaciones de 50 y 460 sucesos; lectura directa de la admisión 461 y finalización 499 de la consulta léxica. Examen del código fijado y comparación documental con fichas oficiales de Qwen. Compilación de la versión 0.1.1 con Rust/Cargo 1.98.0, dependencias bloqueadas, Cargo en modo offline y un trabajo; finalización satisfactoria en 1 min 23 s. Huella del ejecutable y comprobación local del servicio conservadas en la evidencia. Los tiques distinguen observaciones, causas pendientes y aceptación. Concordancia de S39 revisión 7 en CSV, Markdown e historial; otras filas e instantáneas históricas preservadas.

**evidencias:** https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/ACTA_004_FINALIDAD_ALCANCE_Y_CONTINUIDAD_EIO_2026_09_22.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/tuberias-ia/continuacion-15-09-2026/S39_RECEPCION_DOCUMENTAL_INSTALACION_2026_09_22.json ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/fae1add308dcf7079e3d46e7a0c969716139d26f/respuestas-ejecucion/EIO-GITHUB-01/entrega-04/controles-nativos-01/revision-04/RESPUESTA.md ; https://github.com/juantoniolloretegea/SV-sala-de-maquinas/blob/10484cf7a6bd5ae5fd4a132e0aeb6ab6ec58044e/watson-herramientas/evidencias/cualificacion-medidor-20260921/INFORME.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/inicio.md ; https://github.com/juantoniolloretegea/SV-lenguaje-de-computacion/blob/main/docs/calidad/Inventario-sv/tiques-tecnicos/json/EIO_2026-09-22_revision-01.json ; https://github.com/juantoniolloretegea/SV-motor/blob/eec0d87fd9e41a3341b799540bb4545c6dd686d9/laboratorio/ensayo-ia-y-observabilidad/conversacion-nativa/REVISION_SESION_2026_09_22.json

**referencia_calidad:** Acta 004 y RETP-2026-268 como antecedentes de finalidad y recepción documental; S39 revisión 7 y TT-0001–TT-0006 para el seguimiento técnico posterior. No se emite una nueva acta ni una conformidad profesional general. TT-0007 y TT-0008: entrega Beta y consulta documental.

**siguiente_accion:** Identificar y empaquetar la versión Beta con composición, licencias, límites y evidencias. Ejecutar una prueba acotada de fidelidad a pasajes efectivamente suministrados de OP-IMM-001, con condiciones y resultados esperados previos. Registrar ambos trabajos en TT-0007 y TT-0008. No se declara cerrado el universo ni realizada la guarda, custodia separada o integración completa de la vía B; la revisión integral de la adenda permanece para el paso posterior.

**observaciones:** El registro de Sucesos conserva los hitos; los tiques describen cada cuestión técnica y los JSON/JSONL de ejecución conservan los hechos instrumentados. Un cierre normal no valida contenido; external_operations: 0 de la versión 0.1.0 era una constante. La nueva compilación se efectuó después de terminar la petición examinada, por lo que esa petición no constituye un ensayo de competencia con el compilador. El código actualizado no modifica pesos, muestreo ni antecedentes. S22, S32, S37, S38, S40, S41, las fases del Lenguaje y el mapa HTML conservan sus alcances y estados. No se publican conversaciones clínicas completas ni credenciales. El corpus inicial contiene el documento SV, no el texto íntegro de su bibliografía. La prueba no constituye una operación clínica, una modificación del dominio o una promoción de resultados al núcleo o la IR. No se sustituyen pesos, no se elevan recursos y no se permiten gastos.
