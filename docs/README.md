...
## Documentos rectores de fase

- `docs/gobierno/PLIEGO_DE_CONDICIONES_DEL_SISTEMA_VECTORIAL_SV.md`
- `docs/gobierno/WISHLIST_IRQ_DEL_ECOSISTEMA_SV.md`
- `docs/manual_svp/CONSTRUCTOR_DEL_MANUAL_DEL_LENGUAJE_SVP.md`

## Regla de lectura

El pliego opera como ley interna de fase. El Wishlist IRQ recoge y prioriza ideas nuevas sin contaminar la ruta activa. El constructor del manual SVP ordena el cierre progresivo del manual del lenguaje.
