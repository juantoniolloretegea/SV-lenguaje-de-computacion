...
Guías, tutoriales y referencia del lenguaje de computación del Sistema Vectorial SV.
...
La fase actual del repositorio queda ya orientada al **cierre operativo del Lenguaje de Programación Vectorial Poligonal, SV**.

Documentos rectores inmediatos de este frente:
