...
while IFS= read -r -d '' path; do
  case "$path" in
    ./rust/sv_core/assets/manifiesto-sv.md|./LICENSE|./CORTE_GIT.txt|./INVENTARIO.sha256|./rust/*.toml|./rust/*.rs|./tests/*.svp|./tests/*.json|./tests/*.rs|./tests/*.sha256|./tests/row7_candidate/COMPILACION.md|./tests/retorno_cyb/reglas_documentales.mjs|./tests/retorno_cyb/consumir.mjs) ;;
    *) fail PAQUETE_TIPO ;;
  esac
