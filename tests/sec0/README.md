...
- `MATRIZ_CORRESPONDENCIA_ALCANCE_SEC0_V1.md`: correspondencia entre vector, propiedad y condición mínima de alcance causal, sin atribuir cobertura ejecutada.
