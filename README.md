...
| Conformidad vigente | **93/93** | 14 casos válidos y 79 inválidos, incluidos N0-01 a N0-04, BridgeSet y tipos del horizonte. |
| `sv_core` | **210/210 + N0-01 3/3 + N0-02 6/6 + N0-03 5/5 + N0-04 5/5 + BridgeSet 3/3 + Horizon.events 3/3** | Suite interna e integración de codominios, semánticas, mapas JSON y referencias de arquitectura. |
