...
E113 = SVPErrorDef("E113", "EdgeConnectorMismatch",
    "Edge incompatible con BridgeSet, target_position o codominio fuente declarados",
    ErrorLevel.LAYER1, ErrorPhase.VALIDATE)

E114 = SVPErrorDef("E114", "SimpleRegimeConcurrency",
...
E215 = SVPErrorDef("E215", "GateTableSignatureMismatch",
...
E406 = SVPErrorDef("E406", "InsufficientTransitionData",
    "TransitionData debe especificar al menos un cambio en induced_parameters",
    ErrorLevel.LAYER3, ErrorPhase.VALIDATE)
