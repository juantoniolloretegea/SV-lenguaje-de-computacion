...
from svp_errors import (SVPError, E001, E010, E201, E203, E204,
                         E205, E206, E207, E208, E209, E210, E507)
...
class Parser:
    ...
    def _expect_tri(self) -> str:
        ...
        if t.type in (TT.ZERO, TT.ONE, TT.U_LIT):
            self._advance()
            return t.value
        if t.type in (TT.KW_NULL, TT.KW_NONE):
            raise SVPError(E507, t.line, t.col,
                           f"Se detectó coerción implícita de U mediante {t.value!r}")
