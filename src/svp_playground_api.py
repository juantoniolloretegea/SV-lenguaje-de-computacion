...
def compile_for_playground(source: str, filename: str = "playground.svp") -> str:
    ...
    try:
        ...
        envelope = {
            ...
            "ir_json": None,
            "error": {
                "code": getattr(e.error_def, "code", "E000"),
                "name": getattr(e.error_def, "name", "UnknownError"),
                "message": getattr(e.error_def, "message", str(e)),
                "detail": getattr(e, "detail", "") or None,
